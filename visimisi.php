                    ...
                    <div class="row pt-2 pb-4">
                        <div class="col-6 col-md-9">
                            <ul class="list-inline">
                                <li class="py-2 border-top border-bottom"><i class="fa fa-check text-primary mr-3"></i> Terwujudnya kenyamanan dan kelancaran aktivitas akademica terkait listrik</li>
                                <li class="py-2 border-bottom"><i class="fa fa-check text-primary mr-3"></i> Terwujudnya kenyamanan dan kelancaran aktivitas akademica terkait bangunan</li>
                                <li class="py-2 border-bottom"><i class="fa fa-check text-primary mr-3"></i> Terwujudnya kenyamanan dan kelancaran aktivitas akademica terkait  air</li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-7">
                    ...
                    <div class="row pt-2 pb-4">
                        <div class="col-6 col-md-12">
                            <ul class="list-inline">
                                <li class="py-2 border-top border-bottom"><i class="fa fa-check text-primary mr-3"></i> Memberikan pelayanan yang cepat dan tanggap terhadap keluhan user</li>
                                <li class="py-2 border-bottom"><i class="fa fa-check text-primary mr-3"></i> Memberi manfaat dan kontribusi yang baik bagi akademika terkait kebutuhan jasa unit maintenance</li>
                            </ul>
                        </div>
                    </div>
                </div>
