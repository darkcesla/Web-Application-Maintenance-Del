  ...
  <div class="container-fluid pt-3">
        <div class="container">
            <div class="text-center pb-2">
                <h1 class="mb-4">Sarana & Prasarana IT Del</h1>
            </div>
        </div>
    </div>
    <br>
    ...
    <div class="container">
        <div class="row my-2">
            <div class="col-md">
                <a href="cetak.php" target="_blank" name="cetak" class="btn btn-success ms-1"><i class="bi bi-file-earmark-spreadsheet-fill"></i>&nbsp;Lihat Jadwal Lengkap</a>
                <a href="pdf.php" target="_blank" name="pdf" class="btn btn-warning ms-1"><i class="bi bi-file-earmark-spreadsheet-fill"></i>&nbsp;Unduh</a>
            </div>
