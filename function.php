...
function lapor($data)
{
    ...
    $lapor = "INSERT INTO lapor VALUES ('', '$id_user', '$nama','$email','$date','$lokasi','$detail','$gambar', '$aksi')";
...
function ubah($data)
{
    ...
    $lapor = "UPDATE lapor SET aksi = '$aksi', gambar = '$gambar' WHERE id = $id";
...
function tambah($data)
{
    ...
    $jadwal_kerja = "INSERT INTO jadwal_kerja VALUES ('','$nama','$date','$time_start','$time_end','$lokasi','$tugas')";
...
function dokumen($data)
{
    ...
    $dokumen = "INSERT INTO dokumen VALUES ('','$nama_dok','$file')";
...
function up()
{
  ...
  // Jika ukuran file lebih dari 3.000.000 byte maka akan menampilkan alert dibawah
  if ($ukuranFile > 3000000) {
