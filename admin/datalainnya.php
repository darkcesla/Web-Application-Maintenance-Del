...
<br><br>
    ...
    <div class="container">
        <div class="row my-2">
            <div class="col-md">
                <h3 class="text-center fw-bold text-uppercase">Dokumen</h3>
                <hr>
            </div>
        </div>
        <div class="row my-2">
                    ...
                    <tbody>
                        ...
                        <?php foreach ($dokumen as $row) : ?>
                            <tr>
                                ...
                                <td><?= $row['file']; ?></td>
                                <td>
                                    <a href="hapusdokumen.php?id_dok=<?= $row['id_dok']; ?>" class="btn btn-danger btn-sm" style="font-weight: 600;" onclick="return confirm('Apakah anda yakin ingin menghapus data?');"><i class="bi bi-trash-fill"></i></a>
                                </td>
                            </tr>
                            <?php endforeach; ?>
                    </tbody>
