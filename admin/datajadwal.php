...
<head>
    ...
    <title>Data Jadwal Maintenance Sarana & Prasarana IT Del</title>
</head>
...
<body>
    ...
    <div class="container">
        <div class="row my-2">
            <div class="col-md">
                <h3 class="text-center fw-bold text-uppercase">Data Jadwal Kerja</h3>
                <hr>
            </div>
        </div>
        <div class="row my-2">
            <div class="col-md">
                <a href="addJadwalKerja.php" class="btn btn-primary"><i class="bi bi-person-plus-fill"></i>&nbsp;Tambah Data</a>
            </div>
        </div>
        <div class="row my-2">
            <div class="col-md">
                    ...
                    <tbody>
                        ...
                        <?php foreach ($jadwal_kerja as $row) : ?>
                            <tr>
                                ...
                                <td>
                                    <a href="ubah_jadwal.php?id_jadwal=<?= $row['id_jadwal']; ?>" class="btn btn-warning btn-sm" style="font-weight: 600;"><i class="bi bi-pencil-square"></i></a> ||
                                    <a href="hapusjadwal.php?id_jadwal=<?= $row['id_jadwal']; ?>" class="btn btn-danger btn-sm" style="font-weight: 600;" onclick="return confirm('Apakah anda yakin ingin menghapus data?');"><i class="bi bi-trash-fill"></i></a>
                                </td>
                            </tr>
                            <?php endforeach; ?>
                    </tbody>
