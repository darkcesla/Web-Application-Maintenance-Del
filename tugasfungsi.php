                    ...
                    <div class="row pt-2 pb-4">
                        <div class="col-6 col-md-12">
                            <ul class="list-inline">
                                <li class="py-2 border-top border-bottom"><i class="fa fa-check text-primary mr-3"></i> Melakukan perbaikan kerusakan terkait bangunan,plumbing dan listrik</li>
                                <li class="py-2 border-bottom"><i class="fa fa-check text-primary mr-3"></i> Melakukan pemeliharaan bangunan</li>
                                <li class="py-2 border-bottom"><i class="fa fa-check text-primary mr-3"></i> Membantu Sivitas Del dalam tugas-tugas tertentu yang membutuhkan jasa maintenance</li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="row align-items-center">
                <div class="col-lg-7">
                    ...
                    <div class="row pt-2 pb-4">
                        <div class="col-6 col-md-12">
                            <ul class="list-inline">
                                <li class="py-2 border-top border-bottom"><i class="fa fa-check text-primary mr-3"></i> Sebagai penunjang kelancaran aktivitas proses belajar mengajar baik dalam kampus,kantor asrama dan hunian para Tendik</li>
                            </ul>
                        </div>
                    </div>
                </div>
